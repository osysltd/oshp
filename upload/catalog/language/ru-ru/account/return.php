<?php
// Heading
$_['heading_title']			= 'Возврат';

// Text
$_['text_account']			= 'Личный Кабинет';
$_['text_return']				= 'Информация о возврате';
$_['text_return_detail']	= 'Детали возврата';
$_['text_description']		= '<p>Пожалуйста, заполните форму запроса на возврат.</p>';
$_['text_order']				= 'Информация о заказе';
$_['text_product']			= 'Информация';
...
$_['text_empty']				= 'У Вас не было раньше возвратов!';
...
$_['error_product']      = 'Наименование должно быть от 3 до 255 символов!';

...
CREATE TABLE `oc_address` (
  ...
  INDEX `address_customer_idx` (`customer_id`),
  INDEX `address_country_idx` (`country_id`),
  INDEX `address_zone_idx` (`zone_id`),
...
CREATE TABLE `oc_api_ip` (
  ...
  INDEX `api_ip_api_idx` (`api_id`),
  CONSTRAINT `api_ip_api_fk`
	FOREIGN KEY (`api_id`)
	REFERENCES `oc_api`(`api_id`)
...
CREATE TABLE `oc_api_session` (
  ...
  INDEX `api_session_api_idx` (`api_id`),
  CONSTRAINT `api_session_api_fk`
	FOREIGN KEY (`api_id`)
	REFERENCES `oc_api`(`api_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_attribute` (
  ...
  INDEX `attribute_user_idx`(`user_id`),
  INDEX `attribute_attribute_group_idx` (`attribute_group_id`),
  CONSTRAINT `attribute_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE SET NULL,
  CONSTRAINT `attribute_attribute_group_fk`
	FOREIGN KEY (`attribute_group_id`)
	REFERENCES `oc_attribute_group`(`attribute_group_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
--
...
CREATE TABLE `oc_attribute_description` (
  ...
  INDEX `attribute_description_language_idx` (`language_id`),
  CONSTRAINT `attribute_description_attribute_fk`
	FOREIGN KEY (`attribute_id`)
	REFERENCES `oc_attribute`(`attribute_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `attribute_description_language_fk`
...
CREATE TABLE `oc_attribute_group` (
  ...
  INDEX `attribute_group_user_idx`(`user_id`),
  CONSTRAINT `attribute_group_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_attribute_group_description` (
  ...
  INDEX `attribute_description_language_idx` (`language_id`),
  CONSTRAINT `attribute_group_description_attribute_fk`
	FOREIGN KEY (`attribute_group_id`)
	REFERENCES `oc_attribute_group`(`attribute_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `attribute_group_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_banner` (
  ...
  INDEX `banner_user_idx`(`user_id`),
  CONSTRAINT `banner_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_banner_image` (
  ...
  INDEX `banner_image_banner_idx` (`banner_id`),
  INDEX `banner_image_language_idx` (`language_id`),
  CONSTRAINT `banner_image_banner_fk`
	FOREIGN KEY (`banner_id`)
	REFERENCES `oc_banner`(`banner_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `banner_image_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_cart` (
  ...
  INDEX `cart_customer_idx` (`customer_id`),
  INDEX `cart_session_idx` (`session_id`),
  INDEX `cart_product_idx` (`product_id`),
  INDEX `cart_recurring_idx` (`recurring_id`),
  ...
  CONSTRAINT `cart_product_fk`
	...
	ON UPDATE CASCADE ON DELETE RESTRICT
  /* CONSTRAINT `cart_recurring_fk`
	FOREIGN KEY (`recurring_id`)
	REFERENCES `oc_recurring`(`recurring_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT */
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_category_description` (
  ...
  INDEX `category_description_language_idx` (`language_id`),
  INDEX `category_description_name_idx` (`name`),
  CONSTRAINT `category_description_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `category_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_category_filter` (
  ...
  INDEX `category_filter_filter_idx` (`filter_id`),
  CONSTRAINT `category_filter_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `category_filter_filter_fk`
	FOREIGN KEY (`filter_id`)
	REFERENCES `oc_filter`(`filter_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_category_path` (
  ...
  INDEX `category_path_path_idx` (`path_id`),
  CONSTRAINT `category_path_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `category_path_path_fk`
	FOREIGN KEY (`path_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_category_to_layout` (
  ...
  INDEX `category_to_layout_store_idx` (`store_id`),
  INDEX `category_to_layout_layout_idx` (`layout_id`),
  CONSTRAINT `category_to_layout_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `category_to_layout_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `category_to_layout_layout_fk`
	FOREIGN KEY (`layout_id`)
	REFERENCES `oc_layout`(`layout_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_category_to_store` (
  ...
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`),
  INDEX `category_to_store_store_idx` (`store_id`),
  CONSTRAINT `category_to_store_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `category_to_store_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_coupon` (
  ...
  INDEX `coupon_user_idx`(`user_id`),
  CONSTRAINT `coupon_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_coupon_category` (
  ...
  INDEX `coupon_category_category_idx` (`category_id`),
  CONSTRAINT `coupon_category_coupon_fk`
	FOREIGN KEY (`coupon_id`)
	REFERENCES `oc_coupon`(`coupon_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `coupon_category_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_coupon_history` (
  ...
  INDEX `coupon_history_coupon_idx` (`coupon_id`),
  INDEX `coupon_history_order_idx` (`order_id`),
  INDEX `coupon_history_customer_idx` (`customer_id`),
  CONSTRAINT `coupon_history_coupon_fk`
	FOREIGN KEY (`coupon_id`)
	REFERENCES `oc_coupon`(`coupon_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `coupon_history_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `coupon_history_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_coupon_product` (
  ...
  INDEX `coupon_product_coupon_idx` (`coupon_id`),
  INDEX `coupon_product_product_idx` (`product_id`),
  CONSTRAINT `coupon_product_coupon_fk`
	FOREIGN KEY (`coupon_id`)
	REFERENCES `oc_coupon`(`coupon_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `coupon_product_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(2, 'US Dollar', 'USD', '$', '', '2', 0.60000000, 0, '2014-09-25 14:40:00'),
(3, 'Euro', 'EUR', '', '€', '2', 0.65000000, 0, '2014-09-25 14:40:00');
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_customer` (
  ...
  INDEX `customer_customer_group_idx` (`customer_group_id`),
  INDEX `customer_store_idx` (`store_id`),
  INDEX `customer_language_idx` (`language_id`),
  CONSTRAINT `customer_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `customer_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
...
--
INSERT INTO `oc_customer` (`firstname`, `status`, `approved`) VALUES ('Guest', 1, 1);
...
CREATE TABLE `oc_customer_activity` (
  ...
  INDEX `customer_activity_customer_idx` (`customer_id`),
...
CREATE TABLE `oc_customer_group` (
  ...
  /* INDEX `customer_group_user_idx`(`user_id`),
  CONSTRAINT `customer_group_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE*/
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_customer_group_description` (
  ...
  INDEX `customer_group_description_language_idx` (`language_id`),
  CONSTRAINT `customer_group_description_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `customer_group_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 1, 'Обычный', 'По умолчанию'),
(2, 1, 'Постоянный', 'Постоянный клиент'),
(3, 1, 'Оптовый', 'Оптовый клиент');
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_customer_history` (
  ...
  INDEX `customer_history_customer_idx` (`customer_id`),
...
CREATE TABLE `oc_customer_ip` (
  ...
  KEY `ip` (`ip`),
  INDEX `customer_ip_customer_idx` (`customer_id`),
...
CREATE TABLE `oc_customer_online` (
  ...
  `date_added` datetime NOT NULL,
  PRIMARY KEY (`ip`),
  INDEX `customer_online_customer_idx` (`customer_id`),
  CONSTRAINT `customer_online_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_customer_reward` (
  ...
  INDEX `customer_reward_customer_idx` (`customer_id`),
  INDEX `customer_reward_order_idx` (`order_id`),
  CONSTRAINT `customer_reward_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `customer_reward_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_customer_transaction` (
  ...
  INDEX `customer_transaction_customer_idx` (`customer_id`),
  INDEX `customer_transaction_order_idx` (`order_id`),
  CONSTRAINT `customer_transaction_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `customer_transaction_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_customer_search` (
  ...
  INDEX `customer_search_store_idx` (`store_id`),
  INDEX `customer_search_language_idx` (`language_id`),
  INDEX `customer_search_customer_idx` (`customer_id`),
  INDEX `customer_search_category_idx` (`category_id`),
  CONSTRAINT `customer_search_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `customer_search_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `customer_search_customer_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `customer_search_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_customer_wishlist` (
  ...
  INDEX `customer_wishlist_product_idx` (`product_id`),
  CONSTRAINT `customer_wishlist_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `customer_wishlist_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_custom_field_customer_group` (
  ...
  INDEX `custom_field_customer_group_idx` (`customer_group_id`),
  CONSTRAINT `custom_field_customer_group_custom_field_fk`
	FOREIGN KEY (`custom_field_id`)
	REFERENCES `oc_custom_field`(`custom_field_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `custom_field_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_custom_field_description` (
  ...
  INDEX `custom_field_description_language_idx` (`language_id`),
  CONSTRAINT `custom_field_description_custom_field_fk`
	FOREIGN KEY (`custom_field_id`)
	REFERENCES `oc_custom_field`(`custom_field_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `custom_field_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_custom_field_value` (
  ...
  INDEX `custom_field_value_custom_field_idx` (`custom_field_id`),
  CONSTRAINT `custom_field_value_custom_field_fk`
	FOREIGN KEY (`custom_field_id`)
	REFERENCES `oc_custom_field`(`custom_field_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_custom_field_value_description` (
  ...
  INDEX `custom_field_value_description_language_idx` (`language_id`),
  INDEX `custom_field_value_description_custom_field_idx` (`custom_field_id`),
  CONSTRAINT `custom_field_value_description_custom_field_value_fk`
	FOREIGN KEY (`custom_field_value_id`)
	REFERENCES `oc_custom_field_value`(`custom_field_value_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `custom_field_value_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `custom_field_value_description_custom_field_fk`
	FOREIGN KEY (`custom_field_id`)
	REFERENCES `oc_custom_field`(`custom_field_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_download_description` (
  ...
  INDEX `download_description_language_idx` (`language_id`),
  CONSTRAINT `download_description_download_fk`
	FOREIGN KEY (`download_id`)
	REFERENCES `oc_download`(`download_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `download_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_filter` (
  ...
  INDEX `filter_user_idx`(`user_id`),
  INDEX `filter_filter_group_idx` (`filter_group_id`),
  CONSTRAINT `filter_filter_group_fk`
	FOREIGN KEY (`filter_group_id`)
	REFERENCES `oc_filter_group`(`filter_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `filter_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_filter_description` (
  ...
  INDEX `filter_description_language_idx` (`language_id`),
  INDEX `filter_description_filter_group_idx` (`filter_group_id`),
  CONSTRAINT `filter_description_filter_fk`
	FOREIGN KEY (`filter_id`)
	REFERENCES `oc_filter`(`filter_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `filter_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `filter_description_filter_group_fk`
	FOREIGN KEY (`filter_group_id`)
	REFERENCES `oc_filter_group`(`filter_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_filter_group` (
  ...
  INDEX `filter_group_user_idx`(`user_id`),
  CONSTRAINT `filter_group_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_filter_group_description` (
  ...
  INDEX `filter_group_description_language_idx` (`language_id`),
  CONSTRAINT `filter_group_description_filter_group_fk`
	FOREIGN KEY (`filter_group_id`)
	REFERENCES `oc_filter_group`(`filter_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `filter_group_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_information` (
  ...
  INDEX `information_user_idx`(`user_id`),
  CONSTRAINT `information_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_information_description` (
  ...
  INDEX `information_description_language_idx` (`language_id`),
  CONSTRAINT `information_description_information_fk`
	FOREIGN KEY (`information_id`)
	REFERENCES `oc_information`(`information_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `information_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_information_to_layout` (
  ...
  INDEX `information_to_layout_store_idx` (`store_id`),
  INDEX `information_to_layout_layout_idx` (`layout_id`),
  CONSTRAINT `information_to_layout_information_fk`
	FOREIGN KEY (`information_id`)
	REFERENCES `oc_information`(`information_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `information_to_layout_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `information_to_layout_layout_fk`
	FOREIGN KEY (`layout_id`)
	REFERENCES `oc_layout`(`layout_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_information_to_store` (
  ...
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`),
  INDEX `information_to_store_store_idx` (`store_id`),
  CONSTRAINT `information_to_store_information_fk`
	FOREIGN KEY (`information_id`)
	REFERENCES `oc_information`(`information_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `information_to_store_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 'Russian', 'ru-ru', 'ru_RU,ru_RU.UTF-8,en_US,ru_RU,russian', 'ru.png', 'russian', 1, 1);
...
CREATE TABLE `oc_layout` (
  ...
  INDEX `layout_user_idx`(`user_id`),
  CONSTRAINT `layout_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_layout_module` (
  ...
  INDEX `layout_module_layout_idx` (`layout_id`),
  CONSTRAINT `layout_module_layout_fk`
	FOREIGN KEY (`layout_id`)
	REFERENCES `oc_layout`(`layout_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_layout_route` (
  ...
  INDEX `layout_route_layout_idx` (`layout_id`),
  INDEX `layout_route_store_id` (`store_id`),
  CONSTRAINT `layout_route_layout_fk`
	FOREIGN KEY (`layout_id`)
	REFERENCES `oc_layout`(`layout_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `layout_route_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_length_class_description` (
  ...
  INDEX `length_class_description_language_idx` (`language_id`),
  CONSTRAINT `length_class_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_manufacturer` (
  ...
  INDEX `manufacturer_user_idx`(`user_id`),
  CONSTRAINT `manufacturer_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_manufacturer_to_store` (
  ...
  INDEX `manufacturer_to_store_store_idx` (`store_id`),
  CONSTRAINT `manufacturer_to_store_manufacturer_fk`
	FOREIGN KEY (`manufacturer_id`)
	REFERENCES `oc_manufacturer`(`manufacturer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `manufacturer_to_store_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_option` (
  ...
  INDEX `option_user_idx`(`user_id`),
  CONSTRAINT `option_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_option_description` (
  ...
  INDEX `option_description_language_idx` (`language_id`),
  CONSTRAINT `option_description_option_fk`
	FOREIGN KEY (`option_id`)
	REFERENCES `oc_option`(`option_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `option_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_option_value` (
  ...
  INDEX `option_value_option_idx` (`option_id`),
  CONSTRAINT `option_value_option_fk`
	FOREIGN KEY (`option_id`)
	REFERENCES `oc_option`(`option_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_option_value_description` (
  ...
  INDEX `option_value_description_language_idx` (`language_id`),
  INDEX `option_value_description_option_idx` (`option_id`),
  CONSTRAINT `option_value_description_option_value_fk`
	FOREIGN KEY (`option_value_id`)
	REFERENCES `oc_option_value`(`option_value_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `option_value_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `option_value_description_option_fk`
	FOREIGN KEY (`option_id`)
	REFERENCES `oc_option`(`option_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_order` (
  ...
  INDEX `order_store_idx` (`store_id`),
  INDEX `order_customer_idx` (`customer_id`),
  INDEX `order_customer_group_idx` (`customer_group_id`),
  INDEX `order_payment_country_idx` (`payment_country_id`),
  INDEX `order_payment_zone_idx` (`payment_zone_id`),
  INDEX `order_shipping_country_idx` (`shipping_country_id`),
  INDEX `order_shipping_zone_idx` (`shipping_zone_id`),
  INDEX `order_order_status_idx` (`order_status_id`),
  INDEX `order_affiliate_idx` (`affiliate_id`),
  INDEX `order_marketing_idx` (`marketing_id`),
  INDEX `order_language_idx` (`language_id`),
  INDEX `order_currency_idx` (`currency_id`),
  ...
  CONSTRAINT `order_customer_fk`
	...
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `order_payment_country_fk`
	FOREIGN KEY (`payment_country_id`)
	REFERENCES `oc_country`(`country_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `order_payment_zone_fk`
  ...
  CONSTRAINT `order_affiliate_fk`
	...
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `order_marketing_fk`
	FOREIGN KEY (`marketing_id`)
	REFERENCES `oc_marketing`(`marketing_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT, */
  CONSTRAINT `order_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `order_language_currency_fk`
	FOREIGN KEY (`currency_id`)
	REFERENCES `oc_currency`(`currency_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_order_history` (
  ...
  INDEX `order_history_order_status_idx` (`order_status_id`),
...
CREATE TABLE `oc_order_option` (
  ...
  INDEX `order_option_order_idx` (`order_id`),
  INDEX `order_option_order_product_idx` (`order_product_id`),
  INDEX `order_option_product_option_idx` (`product_option_id`),
  INDEX `order_option_product_option_value_idx` (`product_option_value_id`),
  CONSTRAINT `order_option_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `order_option_order_product_fk`
	FOREIGN KEY (`order_product_id`)
	REFERENCES `oc_order_product`(`order_product_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `order_option_product_option_fk`
	FOREIGN KEY (`product_option_id`)
	REFERENCES `oc_product_option`(`product_option_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
  /* CONSTRAINT `order_option_product_option_value_fk`
	FOREIGN KEY (`product_option_value_id`)
	REFERENCES `oc_product_option_value`(`product_option_value_id`)
	ON UPDATE CASCADE ON DELETE CASCADE */
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_order_recurring` (
  ...
  INDEX `order_recurring_order_idx` (`order_id`),
  INDEX `order_recurring_product_idx` (`product_id`),
  INDEX `order_recurring_recurring_idx` (`recurring_id`),
  CONSTRAINT `order_recurring_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `order_recurring_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `order_recurring_recurring_fk`
	FOREIGN KEY (`recurring_id`)
	REFERENCES `oc_recurring`(`recurring_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_order_recurring_transaction` (
  ...
  INDEX `order_recurring_transaction_order_recurring_idx` (`order_recurring_id`),
  CONSTRAINT `order_recurring_transaction_order_recurring_fk`
	FOREIGN KEY (`order_recurring_id`)
	REFERENCES `oc_order_recurring`(`order_recurring_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_order_status` (
  ...
  INDEX `order_status_language_idx` (`language_id`),
  CONSTRAINT `order_status_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_order_total` (
  ...
  INDEX `order_total_order_idx` (`order_id`),
  CONSTRAINT `order_total_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_order_voucher` (
  ...
  INDEX `order_voucher_order_idx` (`order_id`),
  INDEX `order_voucher_voucher_idx` (`voucher_id`),
  INDEX `order_voucher_voucher_theme_idx` (`voucher_theme_id`),
  CONSTRAINT `order_voucher_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `order_voucher_voucher_fk`
	FOREIGN KEY (`voucher_id`)
	REFERENCES `oc_voucher`(`voucher_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `order_voucher_voucher_theme_fk`
	FOREIGN KEY (`voucher_theme_id`)
	REFERENCES `oc_voucher_theme`(`voucher_theme_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_product` (
  ...
  CONSTRAINT `product_user_fk`
	...
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_stock_status_fk`
	FOREIGN KEY (`stock_status_id`)
	REFERENCES `oc_stock_status`(`stock_status_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `product_manufacturer_fk`
	FOREIGN KEY (`manufacturer_id`)
	REFERENCES `oc_manufacturer`(`manufacturer_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `product_tax_class_fk`
	FOREIGN KEY (`tax_class_id`)
	REFERENCES `oc_tax_class`(`tax_class_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `product_weight_class_fk`
	FOREIGN KEY (`weight_class_id`)
	REFERENCES `oc_weight_class`(`weight_class_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `product_length_class_fk`
	FOREIGN KEY (`length_class_id`)
	REFERENCES `oc_length_class`(`length_class_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
--
...
CREATE TABLE `oc_product_attribute` (
  ...
  INDEX `product_attribute_attribute_idx` (`attribute_id`),
  INDEX `product_attribute_language_idx` (`language_id`),
  ...
  CONSTRAINT `product_attribute_attribute_fk`
	...
	REFERENCES `oc_attribute`(`attribute_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `product_attribute_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_description` (
  ...
  KEY `name` (`name`),
  INDEX `product_description_product_idx` (`product_id`),
  INDEX `product_description_language_idx` (`language_id`),
  CONSTRAINT `product_description_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_discount` (
  ...
  INDEX `product_discount_product_idx` (`product_id`),
  INDEX `product_discount_customer_group_idx` (`customer_group_id`),
  CONSTRAINT `product_discount_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_discount_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_filter` (
  ...
  INDEX `product_filter_filter_idx` (`filter_id`),
  CONSTRAINT `product_filter_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_filter_filter_fk`
	FOREIGN KEY (`filter_id`)
	REFERENCES `oc_filter`(`filter_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_image` (
  ...
  INDEX `product_image_product_idx` (`product_id`),
...
CREATE TABLE `oc_product_option` (
  ...
  INDEX `product_option_option_idx` (`option_id`),
  CONSTRAINT `product_option_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_option_option_fk`
	FOREIGN KEY (`option_id`)
	REFERENCES `oc_option`(`option_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_option_value` (
  ...
  INDEX `product_option_value_product_option_idx` (`product_option_id`),
  INDEX `product_option_value_product_idx` (`product_id`),
  INDEX `product_option_value_option_idx` (`option_id`),
  INDEX `product_option_value_option_value_idx` (`option_value_id`),
  CONSTRAINT `product_option_value_product_option_fk`
	FOREIGN KEY (`product_option_id`)
	REFERENCES `oc_product_option`(`product_option_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_option_value_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_option_value_option_fk`
	FOREIGN KEY (`option_id`)
	REFERENCES `oc_option`(`option_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `product_option_value_option_value_fk`
	FOREIGN KEY (`option_value_id`)
	REFERENCES `oc_option_value`(`option_value_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_recurring` (
  ...
  INDEX `product_recurring_recurring_idx` (`recurring_id`),
  INDEX `product_recurring_customer_group_idx` (`customer_group_id`),
  CONSTRAINT `product_recurring_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_recurring_recurring_fk`
	FOREIGN KEY (`recurring_id`)
	REFERENCES `oc_recurring`(`recurring_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `product_recurring_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_related` (
  ...
  INDEX `product_related_related_idx` (`related_id`),
  CONSTRAINT `product_related_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_related_related_fk`
...
CREATE TABLE `oc_product_reward` (
  ...
  INDEX `product_reward_product_idx` (`product_id`),
  INDEX `product_reward_customer_group_idx` (`customer_group_id`),
  CONSTRAINT `product_reward_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_reward_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_special` (
  ...
  INDEX `product_special_product_idx` (`product_id`),
  INDEX `product_special_customer_group_idx` (`customer_group_id`),
  CONSTRAINT `product_special_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_special_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_to_category` (
  ...
  INDEX `product_to_category_category_idx` (`category_id`),
  CONSTRAINT `product_to_category_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_to_category_category_fk`
	FOREIGN KEY (`category_id`)
	REFERENCES `oc_category`(`category_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_to_download` (
  ...
  INDEX `product_to_download_download_idx` (`download_id`),
  CONSTRAINT `product_to_download_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_to_download_download_fk`
	FOREIGN KEY (`download_id`)
	REFERENCES `oc_download`(`download_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_to_layout` (
  ...
  INDEX `product_to_layout_store_idx` (`store_id`),
  INDEX `product_to_layout_layout_idx` (`layout_id`),
  CONSTRAINT `product_to_layout_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_to_layout_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_product_to_store` (
  ...
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`),
  INDEX `product_to_store_store_idx` (`store_id`),
  CONSTRAINT `product_to_store_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `product_to_store_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_recurring` (
  ...
  INDEX `recurring_user_idx`(`user_id`),
...
CREATE TABLE `oc_recurring_description` (
  ...
  INDEX `recurring_description_language_idx` (`language_id`),
  CONSTRAINT `recurring_description_recurring_fk`
	FOREIGN KEY (`recurring_id`)
	REFERENCES `oc_recurring`(`recurring_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `recurring_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_return` (
  ...
  INDEX `return_order_idx` (`order_id`),
  INDEX `return_product_idx` (`product_id`),
  INDEX `return_customer_idx` (`customer_id`),
  INDEX `return_return_reason_idx` (`return_reason_id`),
  INDEX `return_return_action_idx` (`return_action_id`),
  INDEX `return_return_status_idx` (`return_status_id`),
  CONSTRAINT `return_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `return_product_fk`
	FOREIGN KEY (`product_id`)
	REFERENCES `oc_product`(`product_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `return_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `return_return_reason_fk`
	FOREIGN KEY (`return_reason_id`)
	REFERENCES `oc_return_reason`(`return_reason_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `return_return_action_fk`
	FOREIGN KEY (`return_action_id`)
	REFERENCES `oc_return_action`(`return_action_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `return_return_status_fk`
	FOREIGN KEY (`return_status_id`)
	REFERENCES `oc_return_status`(`return_status_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_return_action` (
  ...
  INDEX `return_action_language_idx` (`language_id`),
  CONSTRAINT `return_action_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 1, 'Средства возвращены'),
(2, 1, 'Ожидание возврата средств'),
(3, 1, 'Выслана замена');
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_return_history` (
  ...
  INDEX `return_history_return_idx` (`return_id`),
  INDEX `return_history_return_status_idx` (`return_status_id`),
  CONSTRAINT `return_history_return_fk`
	FOREIGN KEY (`return_id`)
	REFERENCES `oc_return`(`return_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `return_history_return_status_fk`
	FOREIGN KEY (`return_status_id`)
	REFERENCES `oc_return_status`(`return_status_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_return_reason` (
  ...
  INDEX `return_reason_language_idx` (`language_id`),
  CONSTRAINT `return_reason_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_return_status` (
  ...
  INDEX `return_status_language_idx` (`language_id`),
  CONSTRAINT `return_status_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_review` (
  ...
  INDEX `review_product_idx` (`product_id`),
  INDEX `review_customer_idx` (`customer_id`),
...
CREATE TABLE `oc_setting` (
  ...
  INDEX `setting_store_idx` (`store_id`),
  CONSTRAINT `setting_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(0, 'config', 'config_meta_title', 'Интернет Магазин', 0),
(0, 'config', 'config_meta_description', 'Описание магазина', 0),
...
(0, 'config', 'config_invoice_prefix', 'ZAKAZ-00', 0),
...
(0, 'config', 'config_email', 'email@domain', 0),
...
CREATE TABLE `oc_stock_status` (
  ...
  INDEX `stock_status_language_idx`(`language_id`),
  CONSTRAINT `stock_status_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_store` (
  ...
  INDEX `store_user_idx`(`user_id`),
  CONSTRAINT `store_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
INSERT INTO `oc_store` (`store_id`) VALUES (1);
UPDATE `oc_store` SET `store_id` = 0 WHERE `store_id` = 1;
ALTER TABLE `oc_store` AUTO_INCREMENT = 1;
INSERT INTO `oc_store` (`user_id`, `name`) VALUES
(2, 'Seller1 Store 1'),
(2, 'Seller1 Store 2'),
(3, 'Seller2 Store');
-- --------------------------------------------------------
...
(9, 'Налог НДС', 'Облагаемые налогом', '2014-06-06 23:00:00', '2014-09-09 11:50:31'),
(10, 'Скачиваемые товары', 'Скачиваемые', '2011-09-21 22:19:39', '2011-09-22 10:27:36'),
(11, 'Без НДС', 'Необлагаемые налогом',  '2011-09-21 22:19:39', '2011-09-22 10:27:36');
UPDATE `oc_tax_class` SET `tax_class_id` = 0 WHERE `tax_class_id` = 11;
ALTER TABLE `oc_tax_class` AUTO_INCREMENT = 11;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_tax_rate_to_customer_group` (
  ...
  INDEX `tax_rate_to_customer_group_customer_group_idx`(`customer_group_id`),
  CONSTRAINT `tax_rate_to_customer_group_tax_rate_fk`
	FOREIGN KEY (`tax_rate_id`)
	REFERENCES `oc_tax_rate`(`tax_rate_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `tax_rate_to_customer_group_customer_group_fk`
	FOREIGN KEY (`customer_group_id`)
	REFERENCES `oc_customer_group`(`customer_group_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_tax_rule` (
  ...
  INDEX `tax_rule_tax_class_idx`(`tax_class_id`),
  INDEX `tax_rule_tax_rate_idx`(`tax_rate_id`),
  CONSTRAINT `tax_rule_tax_class_fk`
	FOREIGN KEY (`tax_class_id`)
	REFERENCES `oc_tax_class`(`tax_class_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `tax_rule_tax_rate_fk`
	FOREIGN KEY (`tax_rate_id`)
	REFERENCES `oc_tax_rate`(`tax_rate_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_translation` (
  ...
  CONSTRAINT `translation_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE `oc_user` (
  ...
  CONSTRAINT `user_user_group_fk`
	...
	REFERENCES `oc_user_group`(`user_group_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `oc_voucher` (
  ...
  INDEX `voucher_user_idx`(`user_id`),
  INDEX `voucher_order_idx`(`order_id`),
  INDEX `voucher_theme_idx`(`voucher_theme_id`),
  CONSTRAINT `voucher_user_fk`
	FOREIGN KEY (`user_id`)
	REFERENCES `oc_user`(`user_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `voucher_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `voucher_theme_fk`
	FOREIGN KEY (`voucher_theme_id`)
	REFERENCES `oc_voucher_theme`(`voucher_theme_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_voucher_history` (
  ...
  INDEX `voucher_history_voucher_idx`(`voucher_id`),
  INDEX `voucher_history_order_idx`(`order_id`),
  CONSTRAINT `voucher_history_voucher_fk`
	FOREIGN KEY (`voucher_id`)
	REFERENCES `oc_voucher`(`voucher_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `voucher_history_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_voucher_theme_description` (
  ...
  INDEX `voucher_theme_description_language_idx`(`language_id`),
  CONSTRAINT `voucher_theme_description_voucher_theme_fk`
	FOREIGN KEY (`voucher_theme_id`)
	REFERENCES `oc_voucher_theme`(`voucher_theme_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `voucher_theme_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_weight_class_description` (
  ...
  INDEX `weight_class_description_language_idx`(`language_id`),
  CONSTRAINT `weight_class_description_weight_class_fk`
	FOREIGN KEY (`weight_class_id`)
	REFERENCES `oc_weight_class`(`weight_class_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `weight_class_description_language_fk`
	FOREIGN KEY (`language_id`)
	REFERENCES `oc_language`(`language_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_zone` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`zone_id`),
  INDEX `zone_country_idx`(`country_id`),
  CONSTRAINT `zone_country_fk`
...
CREATE TABLE `oc_zone_to_geo_zone` (
  ...
  INDEX `zone_to_geo_zone_country_idx`(`country_id`),
  INDEX `zone_to_geo_zone_zone_idx`(`zone_id`),
  INDEX `zone_to_geo_zone_geo_zone_idx`(`geo_zone_id`),
  CONSTRAINT `zone_to_geo_zone_country_fk`
	FOREIGN KEY (`country_id`)
	REFERENCES `oc_country`(`country_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `zone_to_geo_zone_geo_zone_fk`
	FOREIGN KEY (`geo_zone_id`)
	REFERENCES `oc_geo_zone`(`geo_zone_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
--
...
CREATE TABLE `oc_customer_affiliate` (
  ...
  `date_added` datetime NOT NULL,
  PRIMARY KEY (`customer_id`),
  INDEX `customer_affiliate_customer_idx` (`customer_id`),
  CONSTRAINT `customer_affiliate_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_customer_affiliate_report` (
  ...
  INDEX `customer_affiliate_customer_idx` (`customer_id`),
  INDEX `customer_affiliate_store_idx` (`store_id`),
  CONSTRAINT `customer_affiliate_report_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `customer_affiliate_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_customer_approval` (
  ...
  INDEX `customer_approval_customer_idx` (`customer_id`),
  CONSTRAINT `customer_approval_customer_fk`
	FOREIGN KEY (`customer_id`)
	REFERENCES `oc_customer`(`customer_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_download_report` (
  ...
  CONSTRAINT `download_report_download_fk`
	...
	REFERENCES `oc_download`(`download_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `download_report_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_marketing_report` (
  ...
  INDEX `marketing_report_marketing_idx` (`marketing_id`),
  INDEX `marketing_report_store_idx` (`store_id`),
  CONSTRAINT `marketing_report_marketing_fk`
	FOREIGN KEY (`marketing_id`)
	REFERENCES `oc_marketing`(`marketing_id`)
	ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT `marketing_report_store_fk`
	FOREIGN KEY (`store_id`)
	REFERENCES `oc_store`(`store_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `oc_extension_path` (
  ...
  INDEX `extension_path_install_idx` (`extension_install_id`),
  CONSTRAINT `extension_path_install_fk`
	FOREIGN KEY (`extension_install_id`)
	REFERENCES `oc_extension_install`(`extension_install_id`)
	ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-----------------------------------------------------------
--
...
CREATE TABLE `oc_order_shipment` (
  ...
  INDEX `order_shipment_courier_idx` (`shipping_courier_id`),
  CONSTRAINT `order_shipment_order_fk`
	FOREIGN KEY (`order_id`)
	REFERENCES `oc_order`(`order_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT `order_shipment_courier_fk`
	FOREIGN KEY (`shipping_courier_id`)
	REFERENCES `oc_shipping_courier`(`shipping_courier_id`)
	ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
-----------------------------------------------------------
--
...
CREATE TABLE `oc_seo_url` (
  ...
  INDEX `seo_url_store_idx` (`store_id`),
  INDEX `seo_url_language_idx` (`language_id`),
  INDEX `seo_url_query` (`query`),
  INDEX `seo_url_keyword` (`keyword`),
